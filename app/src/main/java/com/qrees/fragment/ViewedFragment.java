    ...
    private void showViewedListAPI() {
        ...
        if (Utils.isNetworkAvailable(getContext())) {
            ...
            VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.GET,
                    Constant.URL_WITH_LOGIN + "getViewedUploadsList?"+"limit="+limit+"&start="+start+"&type=view", new Response.Listener<NetworkResponse>() {
                @Override
                public void onResponse(NetworkResponse response) {
                    ...
                    try {
                        ...
                        if (status.equalsIgnoreCase("SUCCESS")) {
                            ...
                            JSONArray homedata = jsonObject.getJSONArray("View");
                            if (homedata != null) {
